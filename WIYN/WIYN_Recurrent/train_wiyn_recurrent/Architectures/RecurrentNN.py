...
h5f = h5py.File('/home/u5/jzariski/TelescopeNet-main/WIYN/WIYN_Recurrent/train_wiyn_recurrent/formatting/TotalDataWIYN_recurrent_with_weather.hdf5', 'r')
...
deep.save('NN_recurrent_acqs_WIYN_AST_dropout.h5')
